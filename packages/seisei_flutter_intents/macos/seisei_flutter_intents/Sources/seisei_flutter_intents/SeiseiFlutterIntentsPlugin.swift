...
/// Starts and retains a headless macOS Flutter engine for Seisei App Intents.
///
/// Host apps can use this from app-owned App Intents or extension targets that
/// include FlutterMacOS. Pair `invokeMethod(_:arguments:)` with
...
public final class SeiseiFlutterIntentsEngineHost {
  ...
  public func ensureStarted() throws -> FlutterMethodChannel {
    ...
    if let dartEntrypointArguments {
      project.dartEntrypointArguments = dartEntrypointArguments
    }
